...
import { AlertCircle, Calendar, Search, BookOpen, Star, TrendingUp, Recycle, CreditCard, Map } from "lucide-react"
...
export default function CitizenHome() {
  return (
    <div className="px-4 py-5 space-y-5">
        ...
        <CardContent className="pt-4 pb-4">
          <div className="flex items-start justify-between gap-3 mb-2">
            <div>
              ...
              <p className="text-xs text-white/70 mt-1">Northgate · Verdana</p>
            </div>
          ...
          <div className="mt-4 rounded-xl bg-white/12 px-3 py-3 flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-white/15 flex items-center justify-center shrink-0">
              <Recycle className="w-4 h-4 text-white" />
            </div>
            <div>
              <p className="text-sm font-semibold">Northgate Challenge</p>
              <p className="text-xs text-white/75">Your zone is <strong>#2</strong> in the region this month</p>
            </div>
            <TrendingUp className="w-4 h-4 text-white ml-auto shrink-0" />
          </div>
        </CardContent>
      </Card>
      ...
      {/* Quick widgets */}
      <div>
        <p className="text-xs uppercase tracking-wide text-muted-foreground font-medium mb-3">Quick Access</p>
